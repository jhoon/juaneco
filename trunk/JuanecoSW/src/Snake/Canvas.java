...
// Constantes del juego
    ...
    private final int tiempo_ms = 35;
// Variables del juego
    private int mov;
    private int movant;
...
// Se crea la matriz de posicionamiento y vectores de posicion en pantalla tanto en X como en Y
...
// Se colocan las primeras posiciones de juaneco
            ...
            posesc[8][9] = 3;     /*La posicion i=8, j=9 es el tronco en horizontal*/
            posesc[8][10] = 9;  /*La posicion i=8, j=10 es la cola*/

            /*porque 1,2 y3*/ if ((posesc[rnd.nextInt(lado / 16)][rnd.nextInt(lado / 16)] != 1) & (posesc[rnd.nextInt(lado / 16)][rnd.nextInt(lado / 16)] != 2) & (posesc[rnd.nextInt(lado / 16)][rnd.nextInt(lado / 16)] != 3)) {
                    ...
                    if (posesc[i][j] == 1) {
                        ...
                        switch (posesc[i - 1][j]) {
                            case 12: {
                                ...
                                posesc[rnd.nextInt(lado / 16 - 1)][rnd.nextInt(lado / 16 -1)] = 13;
                                posesc[i - 1][j] = 1;
                                posesc[i][j] = 0;
                                break;
                            }
                            ...
                            case 13: {
                                ...
                                posesc[rnd.nextInt(lado / 16 - 1)][rnd.nextInt(lado / 16 - 1 )] = 12;
                                posesc[i - 1][j] = 1;
                                posesc[i][j] = 0;
                                break;
                            }
